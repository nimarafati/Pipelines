...
#	$name = "$file/$file.Reordered.sort.bami" ;
	...
	print "\@CMD:samtools view -F 268 $file1/$name1.Reordered.sort.bam | samtools view -bS -t $reference - >$file1/$name1.Reordered.sortP.bam\n";
	system "samtools view -F 268 $file1/$name1.Reordered.sort.bam | samtools view -bS -t $reference - >$file1/$name1.Reordered.sortP.bam ";
	print "\@CMD:samtools view -F 268 $file2/$name2.Reordered.sort.bam | samtools view -bS -t $reference - >$file2/$name2.Reordered.sortP.bam\n";
	system "samtools view -F 268 $file2/$name2.Reordered.sort.bam | samtools view -bS -t $reference - >$file2/$name2.Reordered.sortP.bam ";
	# Sort files by name
	print "\@CMD:samtools sort -@ 2 -m 6G -n $file1/$name1.Reordered.sortP.bam $file1/$name1.Reordered.sortPName\n";
	system "samtools sort -@ 2 -m 6G -n $file1/$name1.Reordered.sortP.bam $file1/$name1.Reordered.sortPName ";
	print "\@CMD:samtools sort -@ 2 -m 6G -n $file2/$name2.Reordered.sortP.bam $file2/$name2.Reordered.sortPName\n";
	system "samtools sort -@ 2 -m 6G -n $file2/$name2.Reordered.sortP.bam $file2/$name2.Reordered.sortPName ";

	my $id;
	print "\@CMD:samtools view $file1/$name1.Reordered.sortPName.bam|\n";
	open PAR1, "samtools view $file1/$name1.Reordered.sortPName.bam|";
	print "\@CMD:samtools view $file2/$name2.Reordered.sortPName.bam|\n";
	open PAR2, "samtools view $file2/$name2.Reordered.sortPName.bam|";
